...
public class LoansController {
    ...
    @PostMapping("/create")
    public ResponseEntity<ResponseDto>createLoan(@RequestParam@Pattern(regexp = "(^$|[0-9]{10})",message = "Mobile number must be in 10 digits ")String mobileNumber){
    ...
    public ResponseEntity<ResponseDto> updateLoan(@Valid@RequestBody LoansDto loansDto){
        ...
        if(isUpdated){
            return ResponseEntity
                    ...
                    .body(new ResponseDto(LoansConstant.STATUS_200,LoansConstant.MESSAGE_201));
        }else {
            return ResponseEntity
